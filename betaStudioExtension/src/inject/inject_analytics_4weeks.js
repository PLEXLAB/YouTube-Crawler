...
function getAud(){
	...
	if(audMetrics.length > 0)
	{
		...
		saveChAnalytics("4weeks", chID, overview_vAnalytics, reach_vAnalytics, eng_vAnalytics, audit_vAnalytics);
		setTimeout(function(){chrome.runtime.sendMessage("getAnalytics_quarter");}, 3000);
	}
}