...
function getAud(){
	...
	if(audMetrics.length > 0)
	{
		...
		saveChAnalytics("year", chID, overview_vAnalytics, reach_vAnalytics, eng_vAnalytics, audit_vAnalytics);
		setTimeout(function(){chrome.runtime.sendMessage("getAnalytics_lifetime");}, 3000);
	}
}