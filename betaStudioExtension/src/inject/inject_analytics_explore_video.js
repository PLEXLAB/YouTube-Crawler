...
function getVideTabBody(){
	...
	if(firstColFlag === true && otherColsFlag === true)
	{
		...
		setTimeout(function(){chrome.runtime.sendMessage({msg: "getAanalytics_explore_Traffic", channelID: chID});}, Math.floor(Math.random() * 15000 + 5000));
		// setTimeout(function(){chrome.runtime.sendMessage("getAanalytics_explore_Traffic");}, Math.floor(Math.random() * 15000 + 5000));
