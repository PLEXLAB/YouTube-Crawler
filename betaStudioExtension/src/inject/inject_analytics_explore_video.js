...
function chkDocReady(){
	if (document.readyState === "complete") {
		...
		tableHeadersInt	= setInterval(getVideoTabHeaders,	1000);
	}
}
...
function getVideTabBody(){
	...
	if(firstColFlag === true && otherColsFlag === true)
	{
		...
		setTimeout(function(){chrome.runtime.sendMessage({msg: "getAanalytics_explore_Traffic", channelID: chID});}, 5000);
	}
}
