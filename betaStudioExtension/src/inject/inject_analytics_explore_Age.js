...
function getVideTabBody(){
	...
	if(firstColFlag === true && otherColsFlag === true)
	{
		...
		// setTimeout(function(){chrome.runtime.sendMessage("getAanalytics_explore_Gender");}, config.getRandomTimeoutInterval());
		setTimeout(function(){chrome.runtime.sendMessage({msg: "getAanalytics_explore_Gender", channelID: chID});}, config.getRandomTimeoutInterval());
	}
}
