...
function getAud(){
	...
	if(audMetrics.length > 0)
	{
		...
		saveChAnalytics("week", chID, overview_vAnalytics, reach_vAnalytics, eng_vAnalytics, audit_vAnalytics);
		setTimeout(function(){chrome.runtime.sendMessage("getAnalytics_4week");}, 3000);
	}
}